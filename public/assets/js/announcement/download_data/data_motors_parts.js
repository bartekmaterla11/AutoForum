$(document).ready(function () {
    $('#submit_5').on('click', function () {
        ...
        var price = div.find('.price_of_motors_parts_form_name');
        var child3 = price.children()[1];
        var priceValue = child3.value;

        var type = div.find('#type_of_motors_parts_form_name');
        var typeValue = type.val();

        var state = div.find('#state_of_motors_parts_form_name');
        ...
        var check = $('#price_arranged_parts_motors');
        var checkValue = 0;
